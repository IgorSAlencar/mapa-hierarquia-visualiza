...
const sqlBuilders = {
  ...
  qtdConsig: (a) => `ISNULL(${a}.QTD_CONSIG_AVERBADO, 0) + ISNULL(${a}.QTD_CONSIG_AVERBADO_PLATAF, 0) + ISNULL(${a}.QTD_CRED_CONSIG_PUB_AVERB, 0) + ISNULL(${a}.QTD_CRED_CONSIG_PRIV_AVERB, 0)`,
  vlrConsig: (a) => `ISNULL(${a}.VLR_CONSIG_CONTRATO_AVERBADO, 0) + ISNULL(${a}.VLR_CONSIG_CONTRATO_AVERBADO_PLATAF, 0) + ISNULL(${a}.VLR_EMPRESTIMO_CRED_CONSIG_PUB_AVERB, 0) + ISNULL(${a}.VLR_EMPRESTIMO_CRED_CONSIG_PRIV_AVERB, 0)`,
  qtdLime: (a) => `ISNULL(${a}.QTD_LIME_DTLHES, 0) + ISNULL(${a}.QTD_LIME_DTLHES_PLATAFORMA, 0)`,
  vlrLime: (a) => `ISNULL(${a}.VLR_LIME_DTLHES_EMPRESTIMO, 0) + ISNULL(${a}.VLR_LIME_DTLHES_EMPRESTIMO_PLATAFORMA, 0)`,
  qtdCreditoParcelado: (a) => `ISNULL(${a}.QTD_CREDITO_PARCEL_DTLHES, 0)`,
  vlrCreditoParcelado: (a) => `ISNULL(${a}.VLR_CREDITO_PARCEL_DTLHES_EMPRESTIMO, 0)`,
...
export const PRODUCTION_HEATMAP_METRICS = [
  ...
  { id: 'vlrCred', label: 'Crédito', shortLabel: 'Crédito', group: 'Crédito', unit: currency, productKey: 'credito', defaultForProduct: true },
  { id: 'qtdCred', label: 'Crédito', shortLabel: 'Crédito', group: 'Crédito', unit: quantity, productKey: 'credito' },
  { id: 'vlrConsig', label: 'Consignado', shortLabel: 'Consignado', group: 'Crédito', unit: currency, productKey: 'consignado', defaultForProduct: true },
  { id: 'qtdConsig', label: 'Consignado', shortLabel: 'Consignado', group: 'Crédito', unit: quantity, productKey: 'consignado' },
  { id: 'vlrLime', label: 'LIME', shortLabel: 'LIME', group: 'Crédito', unit: currency, productKey: 'lime', defaultForProduct: true },
  { id: 'qtdLime', label: 'LIME', shortLabel: 'LIME', group: 'Crédito', unit: quantity, productKey: 'lime' },
  { id: 'vlrCreditoParcelado', label: 'Crédito parcelado', shortLabel: 'Crédito parcelado', group: 'Crédito', unit: currency, productKey: 'credito-parcelado', defaultForProduct: true },
  { id: 'qtdCreditoParcelado', label: 'Crédito parcelado', shortLabel: 'Crédito parcelado', group: 'Crédito', unit: quantity, productKey: 'credito-parcelado' },
